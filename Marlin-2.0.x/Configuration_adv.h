...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 16 // CHADDEVOPS - TESTING was 16
#else
  #define BLOCK_BUFFER_SIZE 16  // CHADDEVOPS - TESTING was 16
#endif
 ...
 */
//#define REALTIME_REPORTING_COMMANDS // CHADDEVOPS was disabled
#if ENABLED(REALTIME_REPORTING_COMMANDS)
 // #define FULL_REPORT_TO_HOST_FEATURE   // Auto-report the machine status like Grbl CNC // CHADDEVOPS was disabled
#endif
...
#define ADVANCED_PAUSE_FEATURE // CHADDEVOPS
  ...
  //#define Z_STEPPER_AUTO_ALIGN          // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       650        // (mA) RMS current. Multiply by 1.414 for peak current. // CHADDEVOPS was 580
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       650 // CHADDEVOPS changed from 580 for Z current for missing steps
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       750 // CHADDEVOPS changed from 580 for Z current for two motors 560 or 620 or 750 or 800
...
//#define MEATPACK                // CHADDEVOPS - Support for MeatPack G-code compression (https://github.com/scottmudge/OctoPrint-MeatPack)
