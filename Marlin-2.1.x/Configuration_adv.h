 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        100 // Seconds //CHADDEVOPS
 ...
 */
#define USE_CONTROLLER_FAN //CHADDEVOPS
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN       // CHADDEVOPS FAN2 assigned to electronics
  ...
  #define CONTROLLER_FAN_EDITABLE         // CHADDEVOPS FAN2 manageable gcode M710
  #if ENABLED(CONTROLLER_FAN_EDITABLE)
    #define CONTROLLER_FAN_MENU             // CHADDEVOPS FAN2 enable screen management menu
  #endif
#endif
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // CHADDEVOPS E3v3 assigned hotend
...
#define HOMING_BUMP_MM      { 4, 4, 2 }       // CHADDEVOPS (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

//#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing
//#define XY_COUNTERPART_BACKOFF_MM 0         // (mm) Backoff X after homing Y, and vice-versa

#define QUICK_HOME                            // CHADDEVOPS If G28 contains XY do a diagonal move first
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500 //CHADDEVOPS
...
#define DEFAULT_MINSEGMENTTIME        30000   // (µs) Set with M205 B. // CHADDEVOPS - was 20000
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //CHADDEVOPS
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define LCD_INFO_MENU //CHADDEVOPS
  ...
  #define STATUS_MESSAGE_SCROLLING //CHADDEVOPS
  ...
  #define LCD_SET_PROGRESS_MANUALLY  // CHADDEVOPS was disabled
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME         // Display estimated time to completion // CHADDEVOPS was disabled
    #if ENABLED(SHOW_REMAINING_TIME)
      #define USE_M73_REMAINING_TIME    // Use remaining time from M73 command instead of estimation // CHADDEVOPS was disabled
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //CHADDEVOPS
   ...
   */
  #define SDCARD_SORT_ALPHA //CHADDEVOPS
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting. //CHADDEVOPS
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option. //CHADDEVOPS
  ...
  #define UTF_FILENAME_SUPPORT //CHADDEVOPS

  #define LONG_FILENAME_HOST_SUPPORT      // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //CHADDEVOPS
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu //CHADDEVOPS
  ...
  #define AUTO_REPORT_SD_STATUS           // Auto-report media status with 'M27 S<seconds>' //CHADDEVOPS
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //CHADDEVOPS
 ...
 */
#define BABYSTEPPING //CHADDEVOPS
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING  //CHADDEVOPS
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). //CHADDEVOPS
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping. //CHADDEVOPS
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //CHADDEVOPS

  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // ENABLE FOR BLTOUCH - CHADDEVOPS
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor //CHADDEVOPS
  #endif
#endif
 ...
 */
#define LIN_ADVANCE  //CHADDEVOPS
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Add a second linear advance constant, configurable with M900.
  #define LIN_ADVANCE_K 0.1    // Unit: mm compression per 1mm/s extruder speed  //CHADDEVOPS
  //#define LA_DEBUG            // Print debug information to serial during operation. Disable for production use.
  #define EXPERIMENTAL_SCURVE // Allow S-Curve Acceleration to be used with LA.  //CHADDEVOPS
  #define ALLOW_LOW_EJERK     // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends.  //CHADDEVOPS
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 16  // CHADDEVOPS - TESTING was 8
...
#define BUFSIZE 16 // CHADDEVOPS - TESTING was 4
...
#define TX_BUFFER_SIZE 16  // CHADDEVOPS - WAS 32

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 32  // CHADDEVOPS - WAS 1024 and disabled

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF  // CHADDEVOPS - WAS disabled
#endif
 ...
 */
#define EMERGENCY_PARSER // CHADDEVOPS was disabled
...
#define SERIAL_FLOAT_PRECISION 4  //CHADDEVOPS
 ...
 */
#define ADVANCED_PAUSE_FEATURE // CHADDEVOPS
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       0  // (mm) The length of filament for a complete unload. // CHADDEVOPS
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle. // CHADDEVOPS
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH         25  // (mm) Length to extrude after loading. //CHADDEVOPS
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           240  // (seconds) Time limit before the nozzle is turned off for safety. CHADDEVOPS
  #define FILAMENT_CHANGE_ALERT_BEEPS         15  // Number of alert beeps to play when a response is needed. CHADDEVOPS
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.  //CHADDEVOPS
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       650        // (mA) RMS current. Multiply by 1.414 for peak current. //CHADDEVOPS
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       650 // CHADDEVOPS changed from 800 for Z current for missing steps
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       800 // CHADDEVOPS for Z current for two motors 560 or 620 or 750 or 800
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      650 //CHADDEVOPS
    #define E0_MICROSTEPS    16
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // CHADDEVOPS - 24 for ender 3 - All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS // CHADDEVOPS DRIVERS
   ...
   */
  #define HYBRID_THRESHOLD // CHADDEVOPS

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD       15 // CHADDEVOPS - was 3
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  72 // CHADDEVOPS
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  70 // CHADDEVOPS
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  10 // CHADDEVOPS
    ...
    #define IMPROVE_HOMING_RELIABILITY // CHADDEVOPS
  #endif
   ...
   */
  #define SQUARE_WAVE_STEPPING // CHADDEVOPS

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continuous reporting.
   */
  #define TMC_DEBUG  //CHADDEVOPS DRIVERS
 ...
 */
#define AUTO_REPORT_POSITION // CHADDEVOPS was disabled
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT // CHADDEVOPS
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations // CHADDEVOPS was disabled
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others) // CHADDEVOPS was disabled
...
#define MEATPACK_ON_SERIAL_PORT_2 // CHADDEVOPS - Support for MeatPack G-code compression (https://github.com/scottmudge/OctoPrint-MeatPack)

#define GCODE_CASE_INSENSITIVE  // Accept G-code sent to the firmware in lowercase  // CHADDEVOPS was disabled
 ...
 */
#define HOST_ACTION_COMMANDS // CHADDEVOPS
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76 // CHADDEVOPS
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback // CHADDEVOPS
